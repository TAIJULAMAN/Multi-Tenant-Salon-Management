    ...
    <div className="flex flex-col gap-2 relative" ref={containerRef}>
      ...
      >
        <input
          ...
          required={required}
          className="w-full rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700 placeholder:text-slate-400 outline-none focus:border-[#635BFF] focus:ring-1 focus:ring-[#635BFF] transition-colors cursor-pointer pr-10"
        />
      ...
      {isOpen && createPortal(
        <div 
          ref={dropdownRef}
          className="absolute z-[9999] w-72 bg-white rounded-xl shadow-xl border border-slate-100 p-4 -translate-y-full"
