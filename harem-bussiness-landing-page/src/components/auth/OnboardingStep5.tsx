      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="flex gap-2 mb-2">
            <div className="flex flex-1 rounded-xl overflow-hidden border border-[#E2E8F0] focus-within:ring-2 focus-within:ring-[#635BFF] focus-within:border-transparent transition-all">
              <input
                type="text"
                value={subdomain}
                onChange={(e) => {
            ...
            <button 
              ...
              className="px-6 py-3 bg-[#EEF2F6] text-[#635BFF] font-semibold text-sm rounded-xl hover:bg-[#E2E8F0] transition-all whitespace-nowrap"
            >
              Check Availability
            </button>
          </div>
