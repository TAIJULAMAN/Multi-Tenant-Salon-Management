      ...
      <div className="w-full lg:w-2/5 flex flex-col p-8 lg:p-24 bg-white">
        ...
        <div className="max-w-md w-full mx-auto lg:mx-0">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-[#E2E8F0] focus:outline-none focus:ring-2 focus:ring-[#635BFF] focus:border-transparent transition-all"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 bg-[#635BFF] text-white rounded-xl font-bold text-lg hover:bg-[#534dfd] transition-all shadow-lg shadow-[#635BFF]/20 flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isLoading ? (
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center space-x-2 py-3 px-4 border border-[#E2E8F0] rounded-xl hover:bg-gray-50 transition-all font-manrope font-semibold text-[#1E293B]">
