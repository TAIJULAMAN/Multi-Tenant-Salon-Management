      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 rounded-[16px] bg-gradient-to-br from-[#F5F3FF] to-[#F5F3FF]/30">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-[10px] bg-[#635BFF] flex items-center justify-center text-white shadow-[0_4px_12px_rgba(99,91,255,0.25)]">
              <Wallet className="w-5 h-5" />
            </div>
            <span className="font-bold text-[12px] text-[#1E293B]">
              Appointments Completed (Last 30-days)
            </span>
          </div>
        ...
        <div className="p-6 rounded-[16px] bg-gradient-to-br from-[#F0FDFA] to-[#F0FDFA]/30">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-[10px] bg-[#14B8A6] flex items-center justify-center text-white shadow-[0_4px_12px_rgba(20,184,166,0.25)]">
              <Calendar className="w-5 h-5" />
            </div>
            <span className="font-bold text-[12px] text-[#1E293B]">
              Appointments Book Now (Last 30 days)
            </span>
          </div>
          <div className="text-[24px] font-bold text-[#1E293B]">
            52
        ...
        <div className="p-6 rounded-[16px] bg-gradient-to-br from-[#F0FDF4] to-[#F0FDF4]/30">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-[10px] bg-[#22C55E] flex items-center justify-center text-white shadow-[0_4px_12px_rgba(34,197,94,0.25)]">
